...
class Var(object):
    MULTI_CLIENT = False
    API_ID = int(getenv('API_ID', '28671918'))
    API_HASH = str(getenv('API_HASH', 'c92b387142fe889740967b453c28d364'))
    BOT_TOKEN = str(getenv('BOT_TOKEN' , '7529441813:AAGwmdjLkzM5oRdpkClbKYz1go1t1alESfA'))
    name = str(getenv('name', 'Martin_Movies_Bot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002480131358'))
    NEW_USER_LOG = int(getenv('NEW_USER_LOG', '-1002480131358'))
    ...
    UPDATES_CHANNEL = str(getenv('UPDATES_CHANNEL', 'UBZ_BOTS')) 
